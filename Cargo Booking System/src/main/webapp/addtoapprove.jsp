...
<head>
  ...
  <body>
       <h1>VIEWING CARGOUSER DETAILS</h1>
  <table>
    <thead>
      <tr>
        <th>BOOKING_ID</th>
...
<!--          <th>CARGO_CHANGE</th> -->
    ...
    <%
			...
			try
			{
				PreparedStatement ps= con.prepareStatement("select * from booking_tbl where booking_status=1");
     ...
     <tr>
							    ...
							    <td><a href="approved.jsp?id=<%=rs.getString("booking_id")%>"><button class="btn color">PENDING</button></a></td>
      ...
      <tr>
		...
		<a href="choice.html"><button class="back"><ion-icon name="arrow-back-outline"></ion-icon>Back</button></a>
    </tbody>
  </table>
