...
<html>
<head>
  <title>VIEWING BOOKING RECORDS</title>
  <style>
    body {
  ...
  <table>
    ...
    <%
			...
			try
			{
				PreparedStatement ps= con.prepareStatement("select * from booking_tbl");
     ...
     <tr>
							    ...
							    <td><a href="deletecargo.jsp?id"><button class="btn">DELETE</button></a></td> 
