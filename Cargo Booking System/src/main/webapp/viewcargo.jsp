  ...
  <table>
    ...
    <%
     ...
     <tr>
							    ...
							    <td><a href="updatecargo.jsp?id=<%=rs.getInt("cargo_id")%>"><button class="btn color">Update</button></a><a href="deletecargo.jsp?id=<%=rs.getInt("cargo_id")%>"><button class="btn">Delete</button></a></td>
